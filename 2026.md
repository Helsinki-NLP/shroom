...
System description papers must be submitted as anonymized PDF files using the [official ACL style templates](https://github.com/acl-org/acl-style-files) and may contain up to **four pages of main content**. A required Limitations section and an optional Ethical Considerations section may follow the conclusion and do not count toward the page limit; references are unlimited. Appendices may follow the references and do not count toward the page limit, but papers must be self-contained because reviewers are not required to consider appendices. Submissions must follow the ARR requirements for [two-way anonymized review and citation](https://aclrollingreview.org/cfp).

Each team submitting a system description paper must nominate one eligible paper author as a reciprocal reviewer. The nominated reviewer must agree to review at least two papers.
